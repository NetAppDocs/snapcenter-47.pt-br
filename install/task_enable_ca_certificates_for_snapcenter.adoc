...
As informações sobre os parâmetros que podem ser usados com o cmdlet e suas descrições podem ser obtidas executando _get-Help command_name_. Em alternativa, pode consultar a https://docs.netapp.com/us-en/snapcenter-cmdlets-47/index.html["Guia de referência de cmdlet do software SnapCenter"^].
...
* image:../media/enable_ca_issues_icon.png["ícone de problemas de ca"]* * Indica que não há certificado CA habilitado ou atribuído ao host do plug-in.
...
* image:../media/enable_ca_undefined_icon.png["ícone ca indefinido"]* * indica que as informações de conexão não puderam ser recuperadas.
