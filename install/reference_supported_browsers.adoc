...
Para obter as informações mais recentes sobre versões suportadas, https://imt.netapp.com/matrix/imt.jsp?components=105046;&solution=1257&isHWU#welcome["Ferramenta de Matriz de interoperabilidade do NetApp"^] consulte .
