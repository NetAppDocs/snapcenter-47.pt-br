...
'''
permalink: Protect-hana/task_cancel_backup_operations_for_sap_hana.html barra lateral: Barra lateral palavras-chave: Resumo: 'Você pode cancelar operações de backup que estão na fila.' Cancelar operações de backup para SAP HANA :icons: Font :imagesdir: ../media/
