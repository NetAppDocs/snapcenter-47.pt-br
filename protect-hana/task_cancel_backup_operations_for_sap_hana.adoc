...
Painel da atividade
 a| 
.. Depois de iniciar a operação de backup, clique em *image:../media/activity_pane_icon.gif["ícone de atividade"]* no painel atividade para exibir as cinco operações mais recentes.
