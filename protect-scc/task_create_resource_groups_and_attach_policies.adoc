...
.. Na coluna *Configurar agendas*, clique em *image:../media/add_policy_from_resourcegroup.gif["adicionar política do grupo de recursos"]* * para a política que deseja configurar.
