...
Para obter os requisitos mínimos do ONTAP e do plug-in de aplicativos, consulte https://imt.netapp.com/matrix/imt.jsp?components=105961;&solution=1259&isHWU&src=IMT["Ferramenta de Matriz de interoperabilidade"^]
