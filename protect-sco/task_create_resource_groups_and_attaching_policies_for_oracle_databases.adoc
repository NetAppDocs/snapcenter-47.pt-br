...
image::../media/sco_resourcegroup_policy.gif[adicionar política do grupo de recursos]
...
.. Clique emimage:../media/add_policy_from_resourcegroup.gif["adicionar política do grupo de recursos"]* * na coluna Configurar agendas para configurar o agendamento de verificação para todos os tipos de agendamento da política.
